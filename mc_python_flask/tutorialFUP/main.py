...
@app.route("/Incripcion", methods=['GET'])
def getIncripcion():
   json = miControladorInscripcion.index()
   return jsonify(json)

@app.route("/Incripcion", methods=['POST'])
def crearIncripcion():
   data = request.get_json()
   json = miControladorInscripcion.create(data)
   return jsonify(json)

@app.route("/Incripcion/<string:id>", methods=['GET'])
def getIncripcion(id):
   json = miControladorInscripcion.show(id)
   return jsonify(json)

@app.route("/Incripcion/<string:id>", methods=['PUT'])
def modificarIncripcion(id):
   data = request.get_json()
   json = miControladorInscripcion.update(id, data)
   return jsonify(json)

@app.route("/Incripcion/<string:id>", methods=['DELETE'])
